    ...
    return (
      <div className="bg-white rounded-2xl border border-[#E2E8F0] p-8 shadow-sm text-center">
        ...
        <p className="text-sm text-[#475569]">
          Cek inbox <strong className="text-[#0F172A]">{email}</strong> dan klik link untuk reset password.
        </p>
      ...
      <form onSubmit={handleReset} className="space-y-4">
        <div>
          ...
          <input
            ...
            required
            className="w-full px-3.5 py-2.5 rounded-lg border-[1.5px] border-[#E2E8F0] bg-white text-sm text-[#0F172A] placeholder:text-[#94A3B8] focus:outline-none focus:ring-2 focus:ring-[#1E3A5F] focus:ring-offset-1 focus:border-transparent"
          />
        </div>
